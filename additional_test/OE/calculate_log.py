...
def confusion_matrix(dir_name):
    ...
    # plt.show()
    plt.savefig('%s/cluster_visualization_OE_additional.jpg' % dir_name,bbox_inches = 'tight')
    plt.close()
    ...
    plt.savefig('%s/distribution_OE_additional.jpg' % dir_name,bbox_inches = 'tight')
    plt.close()
