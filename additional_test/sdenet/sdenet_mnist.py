...
parser.add_argument('--dataset_inDomain', default='cifar10_cat', help='training dataset')
...
parser.add_argument('--decreasing_lr2', default=[30, 60], nargs='+', help='decreasing strategy')
...
net = models.SDENet_mnist(layer_depth=6, num_classes=2, dim=64)
net = net.to(device)
