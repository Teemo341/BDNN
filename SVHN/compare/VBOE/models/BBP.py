...
class BBP(nn.Module):
    def __init__(self):
        ...
        self.feature_layers_0 = ResBlock_Bayesian(64, 64)
        self.feature_layers_1 = ResBlock_Bayesian(64, 64)
        self.feature_layers_2 = ResBlock_Bayesian(64, 64)
        self.feature_layers_3 = ResBlock_Bayesian(64, 64)
        self.feature_layers_4 = ResBlock_Bayesian(64, 64)
        self.feature_layers_5 = ResBlock_Bayesian(64, 64)
