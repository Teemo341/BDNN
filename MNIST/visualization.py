...
# pic = get_picture(pic_dir, transform)

def get_feature(img,network,pretrained_net,exact_list=None):
    ...
    net.load_state_dict(torch.load(pretrained_net))
    dst = './vis/'+network+'/feautures'
    therd_size = 256
