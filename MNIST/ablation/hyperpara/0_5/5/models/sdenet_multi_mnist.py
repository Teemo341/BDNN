...
class Diffusion(nn.Module):
    def __init__(self, dim_in, dim_out):
        ...
        self.conv1 = ConcatConv2d(dim_in, dim_in, 3, 1, 1)
    ...
    def forward(self, x, training_diffusion=False):
        ...
        if not training_diffusion:
            ...
            for i in range(self.layer_depth):
                ...
                out = out + self.drift(t, out)*self.deltat + (self.layer_depth-float(i))/self.layer_depth*diffusion_term*math.sqrt(self.deltat)*torch.randn_like(out).to(x)
